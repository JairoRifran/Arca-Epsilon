...
const catalog = [
  ...
  // --- Player weapons: authored as isolated cinematic layers. The runtime
  // falls back to existing local cues until these files are generated.
  sfx('sfx-player-laser-burst-a', 'sfx_player_laser_burst_a', 1.2, false, 'Cinematic military science-fiction energy cannon burst fired from a spacecraft, three tightly grouped clean high-energy pulses, powerful transient attack, dense electromagnetic body, subtle mechanical emitter response, short controlled tail, precise and realistic, no retro arcade laser, no toy pew sound, no music, no voice, isolated clean sound effect.'),
  sfx('sfx-player-laser-burst-b', 'sfx_player_laser_burst_b', 1.35, false, 'Cinematic military science-fiction spacecraft energy cannon burst, three tightly grouped pulses with a heavier low-frequency body and alternate electromagnetic texture, firm transient, subtle internal hull resonance, short controlled tail, serious and realistic, no retro arcade laser, no toy pew sound, no music, no voice, isolated clean sound effect.'),
  sfx('sfx-player-laser-burst-heavy', 'sfx_player_laser_burst_heavy', 1.5, false, 'Heavy cinematic spacecraft energy cannon burst, tightly integrated triple pulse, dense low electromagnetic pressure, armored emitter resonance and compact thermal tail, serious military science fiction, no arcade laser, no toy sound, no conventional firearm, no music, no voice, isolated effect.'),
  sfx('sfx-player-laser-charge-short', 'sfx_player_laser_charge_short', 0.8, false, 'Very short spacecraft energy emitter accumulation, compact capacitor rise and focused electromagnetic tension resolving immediately, military science fiction, no long charge, no arcade pitch sweep, no music, no voice, isolated effect.'),
  sfx('sfx-player-laser-mechanical-release', 'sfx_player_laser_mechanical_release', 0.8, false, 'Short internal spacecraft cannon mechanical recovery, dense magnetic relay release, ceramic emitter cooling tick and restrained hull response, realistic military science fiction, no weapon shot, no alarm, no music, no voice.'),
  sfx('sfx-player-torpedo-eject', 'sfx_player_torpedo_eject', 1.2, false, 'Cinematic spacecraft torpedo mechanical ejection, heavy magnetic rack release, compact launch tube pressure and believable mass leaving the hull, controlled military science fiction, no ignition yet, no arcade, no music, no voice, isolated effect.'),
  sfx('sfx-player-torpedo-ignite', 'sfx_player_torpedo_ignite', 1.5, false, 'Cinematic spacecraft torpedo launch ignition, heavy mechanical ejection transition into powerful futuristic rocket ignition, dense low-frequency impact, controlled plasma propulsion texture, serious military science fiction, realistic mass and acceleration, no arcade, no music, no voice, isolated clean sound effect.'),
  sfx('sfx-player-torpedo-engine', 'sfx_player_torpedo_engine', 5, true, 'Futuristic guided torpedo engine in space, sustained compact plasma propulsion, deep controlled energy texture, subtle modulation from guidance corrections, cinematic military science fiction, seamless loop, no airplane sound, no arcade laser, no music, no voice.'),
  sfx('sfx-player-torpedo-near-miss', 'sfx_player_torpedo_near_miss', 2, false, 'Guided plasma torpedo passing close to a spacecraft, compact propulsion pressure, fast spatial sweep and brief electromagnetic wake, dangerous realistic military science fiction, no airplane flyby, no arcade, no music, no voice.'),
  sfx('sfx-player-torpedo-impact', 'sfx_player_torpedo_impact', 1.2, false, 'Heavy futuristic torpedo striking spacecraft armor, sharp penetration contact, compressed metal rupture and dense energy transfer before detonation, cinematic military science fiction, no arcade explosion, no music, no voice, isolated effect.'),
  sfx('sfx-player-torpedo-detonation', 'sfx_player_torpedo_detonation', 3.5, false, 'Large cinematic science-fiction torpedo detonation against a spacecraft, initial armor impact, compressed energy burst, deep internal rupture, expanding plasma shock and metallic debris, powerful but controlled, realistic military science fiction, no arcade explosion, no music, no voice, isolated clean sound effect.'),
